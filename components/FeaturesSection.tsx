          ...
          return (
            <div key={feature.id} className="width-fit text-left">
              <div className="flex items-center gap-2">
                ...
                <div className="text-md mb-1 font-normal text-zinc-50 dark:text-gray-100">
                  {feature.name}
                </div>
              </div>
              <div className="font-regular max-w-sm text-xs text-gray-400  dark:text-gray-400">
                {feature.description}
              </div>
            </div>
          );
  ...
  return (
    <div className="my-12 min-w-[90vw] flex w-full flex-col items-center justify-center">
      <h1 className="mb-2 text-center text-2xl font-light tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-400 md:text-3xl ">
        FeedSnap is Not Like Other Feedback App.
      </h1>
      <p className="max-w-md text-center text-sm text-gray-400 ">
        FeedSnap is a free to use, and highly simplified feedback form
        integration website.
      </p>
      <FeaturesGrid />
    </div>
