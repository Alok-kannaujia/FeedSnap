...
const Sidebar = async () => {
  ...
  return (
    <div>
      <aside className="md:flex hidden overflow-x-hidden flex-col w-64 h-full px-5 pt-3 overflow-y-auto bg-black">
        <div className="flex flex-col pb-8 justify-between flex-1 ">
          <nav className="-mx-3 space-y-6 ">
            <div className="space-y-3 ">
              <label className="px-3 flex gap-1 items-center text-xs text-white/50 uppercase dark:text-white/50">
                Features <FileSignature size={12} />
              </label>
              <hr />

              <Link
                className="flex items-center px-3 py-2 text-white/80 transition-colors duration-300 transform rounded-lg dark:text-white/80 hover:bg-balck dark:hover:bg-balck  dark:hover:bg-gray-50/10 hover:bg-gray-50/10"
                href="/dashboard"
              >
                <ChartArea size={16} />
          ...
          <div>
            <div className="py-2">
              <div className="flex justify-between">
                {" "}
                <label className="flex gap-1 py-2 items-center text-xs text-white/50 uppercase dark:text-white/50">
                  Project Limit
                </label>
                <label className="flex gap-1 py-2 items-center text-xs text-white/50 uppercase dark:text-white/50">
                  {projects?.length} / 5
            ...
            <div>
              <Card className="border-border text-card shadow w-full max-w-sm bg-card-foreground rounded-lg">
                <CardContent className="p-3 grid gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="grid gap-1">
                      ...
                      <div className="text-muted-background text-xs">
